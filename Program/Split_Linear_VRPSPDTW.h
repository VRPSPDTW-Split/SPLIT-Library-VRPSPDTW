#ifndef SPLIT_LINEAR_VRPSPDTW_H
#define SPLIT_LINEAR_VRPSPDTW_H

#include "Split.h"
#include "Trivial_Deque.h"

class Split_Linear_VRPSPDTW: public Split 
{
...
inline bool dominated_h(int i, int j) { // switched from original
...
public:
	...
	Split_Linear_VRPSPDTW(Pb_Data * myData) : Split(myData) {}
